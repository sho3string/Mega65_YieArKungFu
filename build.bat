...
cmd /c G:\Mega65\Dev\bin\cc1541.exe -n "yie ar kung fu" -w "G:\Mega65\YiearKungFu\yiearkungfu.prg" -w "G:\Mega65\YiearKungFu\YiearKungFu\assets\tilesheet.chr" -w "G:\Mega65\YiearKungFu\colorram.bin" "G:\Mega65\YiearKungFu\Yiearkf.d81"
