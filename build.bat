...
java -jar G:\Mega65\YiearKungFu\Bin\kickassembler-5.24-65ce02.e.jar -showmem Source/asm/hiscoretbl.asm
cmd /c copy "G:\Mega65\YiearKungFu\Source\asm\hiscore.bin" "G:\Mega65\YiearKungFu\hiscore.bin"
...
cmd /c G:\Mega65\Dev\bin\cc1541.exe -n "yie ar kung fu" -w "G:\Mega65\YiearKungFu\yiearkungfu.prg" -w "G:\Mega65\YiearKungFu\YiearKungFu\assets\ts.chr" -w "G:\Mega65\YiearKungFu\colorram.bin" -w "G:\Mega65\YiearKungFu\plyfld.bin" -w "G:\Mega65\YiearKungFu\hiscore.bin" "G:\Mega65\YiearKungFu\Yiearkf.d81"
