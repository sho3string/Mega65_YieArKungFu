...
!macro mapMemory source,target {
	!set sourceMB = (source & $ff00000) >> 20
	!set sourceOffset = ((source & $00fff00) - target)
	!set sourceOffHi = sourceOffset >> 16
	!set sourceOffLo = (sourceOffset & $0ff00 ) >> 8
	!set bitLo = pow(2, (((target) & $ff00) >> 12) / 2) << 4
	!set bitHi = pow(2, (((target-$8000) & $ff00) >> 12) / 2) << 4
